...
for top_category in top_categories:
    ...
    category_url = host + top_category['herf']
    ...
    for course in courses:
        ...
        course_list.append([index,category_name,url,name,description,author,rating,''])
        ids.append(id)
    ...
    for i in range(len(ids)):
        course_list[i][-1] = prices[ids[i]['price']['price_string']]
        
    write.writerow(course_list)
